...
public class TC005 {
	...
	public static void main(String[] args) throws InterruptedException {
	   ...
	   d.findElementByLinkText("HOLIDAYS").click();
		...
		se6.selectByValue("Yes");
		Thread.sleep(10000);
		d.findElementByName("gstNumber").sendKeys("12345678901");
        d.findElementByName("companyName").sendKeys("abc company");
        d.findElementByName("companyAddress").sendKeys("xyz colony");
        Thread.sleep(10000);
        String gstverifiy = d.findElementByXPath("/html/body/app-root/app-fulllayout/app-paxdetail/div[2]/div/div/div[3]/div/div/div/form/div[9]/div/span").getText();
        if(gstverifiy.equals("Please Enter Valid GSt number")){
