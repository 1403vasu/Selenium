...
public class GenericWrappers implements Wrappers {
	...
	public void invokeApp(String browser, String url) {
		try {
			...
			d.get(url);
			System.out.println("The browser " + browser + " is launched with given " + url + " successfully" );
		} 
		catch(SessionNotCreatedException e) {
			System.err.println("The browser "+browser+" is not launced with given url "+url+" due to session not created error");
		} catch(InvalidArgumentException e) {
			System.err.println("The browser "+browser+" is not launced as url "+url+"  doesnt contain https/https");
		} catch(WebDriverException e) {
			System.err.println("The browse "+browser+" is not launced due to unknown error");
		}
	}
	@Override
	public void enterById(String idValue, String data) {
	    try {
			d.findElementById(idValue).sendKeys(data);
		     System.out.print("The element with id "+idValue+" is entered with "+data);
		} catch (NoSuchElementException e) {
			System.err.print("The element with id "+idValue+" is not in the dom"+data);
		} catch(ElementNotVisibleException e) {
		 
			System.err.print("The element with "+idValue+" is not not interactable"+data);
		}catch(StaleElementReferenceException e)
	    {
			System.err.print("The element with "+idValue+" is not stable to interact"+data);
	    }catch(WebDriverException e) {
	    	System.err.print("The element with data "+idValue+" is entered with data "+data);
	    } 
	}
@Override
	public void enterByName(String nameValue, String data) {
		try {
			...
			System.out.print("The element with "+nameValue+" is entered with "+data);
	...
	public void enterByXpath(String xpathValue, String data) {
		...
		try {
			d.findElementByXPath(xpathValue).sendKeys(data);
			 System.out.print("The element with "+xpathValue+" is entered with "+data);
		} 
			catch (NoSuchElementException e) {
	...
	public void verifyTitle(String title) {
		try {
			...
			System.err.print("The title of page "+title+"is not verified due to unknown error");
		}
		}
	@Override
	public void verifyTextById(String id, String text) {
	 try {
		...
		System.err.print("The title of page "+id+"is not verified due to unknown error");
	}}
	 @Override
	public void verifyTextByXpath(String xpath, String text) {
		 try {
			...
			System.err.print("The title of page "+xpath+"is not verified due to unknown error");
		}}
	@Override
...
@Override
	...
	public String getTextById(String idVal) {
	   ...
	   System.out.println("Id for the text is "+id1);
			...
			System.err.print("The element with id "+idVal+" is not present in the dom");
		}
	...
	public String getTextByXpath(String xpathVal) {
		...
		try {
			 ...
			 System.out.println("The element with  xpath "+xp+" is present");
		}
		catch (NoSuchElementException e) {
...
try {
	...
	public long takeSnap() {
		long number = 0;
			try {
				...
				System.err.print("The browser is not closed due to unknown error");
				//The browser is not closed due to unknown error","fail",false
			}
			return number ;
	...
	public void closeBrowser() {
		try {
			...
			// TODO Auto-generated catch block
			System.err.print("The browser window is not cloased as there is no such element");
		} catch (WebDriverException e) {
			System.err.print("The browser is not closed due to unknown error");
		}
	...
	public void defcontent() {
		try {
			...
			System.err.print("No such window present in dom"); 
		}
		catch (WebDriverException e) {
			System.err.print("No such Driver present in dom");
	}
	}
